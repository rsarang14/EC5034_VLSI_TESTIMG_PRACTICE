...
module tb_top;
    ...
    // -----------------------------------------------------------------
    // 1. Clock Generation (ONLY place where # delay is allowed)
    // -----------------------------------------------------------------
    initial begin
        clk = 0;
    ...
    // -----------------------------------------------------------------
    // 2. Synchronous Test Task (NO hardcoded # delays!)
    // -----------------------------------------------------------------
    ...
    initial begin
        ...
        $display("=================================================================================");
        $display("                     LAB 1: SEQUENTIAL MULTIPLIER TESTBENCH                      ");
        $display("=================================================================================");

        // --- Section 6 Required Cases ---
        // Corner cases: 0x0, 0xN, Nx0, 1x1, 1x15, 15x1
        run_test(4'd0, 4'd0);
        run_test(4'd0, 4'd5);
        run_test(4'd5, 4'd0);
        run_test(4'd1, 4'd1);
        ...
        // Section 8 Cycle Verification Case (3 x 4)
        run_test(4'd3, 4'd4);

        // Maximum case: 15 x 15
        run_test(4'd15, 4'd15);

        // Commutativity check: 3 x 12 vs 12 x 3
        run_test(4'd3, 4'd12);
        run_test(4'd12, 4'd3);
